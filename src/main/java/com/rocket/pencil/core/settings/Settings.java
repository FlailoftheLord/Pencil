package com.rocket.pencil.core.settings;
...
public class Settings {
    ...
    private static final Settings textures = new Settings("textures");
    ...
    public static Settings getTextures() {
        return textures;
    }
    ...
    private Settings(String fileName) {
        if (!Pencil.getPencil().getDataFolder().exists()) {
