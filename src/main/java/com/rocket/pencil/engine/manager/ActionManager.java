 ...
 *
 *         Manager that manages all the actions for a specific player. Each
 *         player has it's own ActionManager.
 *
 * @see PencilPlayer
 */
public class ActionManager {
	...
	/**
	 * Add actions to the players action stream. A LinkedList automatically allows
	 * for a flipped action tree!
	 *
