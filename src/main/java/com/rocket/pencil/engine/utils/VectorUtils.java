...
public class VectorUtils {
    ...
    public static Vector getPreciseTargetBlock(PencilPlayer player) {
        World world = player.getPlayer().getWorld();
        Block calibrator = player.getPlayer().getTargetBlock(null, 5);

        org.bukkit.util.Vector start = new org.bukkit.util.Vector(
        ...
        org.bukkit.util.Vector direction = new org.bukkit.util.Vector(
                calibrator.getLocation().getBlockX(),
                calibrator.getLocation().getBlockY(),
                calibrator.getLocation().getBlockZ()
        );

        BlockIterator iterator = new BlockIterator(world, start, direction, 0, 0);
