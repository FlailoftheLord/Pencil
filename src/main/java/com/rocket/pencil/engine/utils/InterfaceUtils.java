...
public class InterfaceUtils {
	...
	public static Inventory getCrayonMenu() {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Main Menu",
				PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);

		gui.setItem(10, ItemUtils.getWandItem());
		gui.setItem(11, ItemUtils.getSkullItem(1, ItemUtils.flashlight, ChatColor.AQUA + "Position Selection"));
		gui.setItem(12, ItemUtils.getItem(Material.STICK, 1, ChatColor.AQUA + "Player Modes"));
		gui.setItem(13, ItemUtils.getItem(Material.FILLED_MAP, 1, ChatColor.AQUA + "Utilities"));

		return gui;
	}

	public static Inventory getUtilitiesMenu() {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Utilities",
				PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);

		gui.setItem(10, ItemUtils.getItem(Material.WRITABLE_BOOK, 1, ChatColor.AQUA + "History"));
		gui.setItem(11, ItemUtils.getItem(Material.DIAMOND_SHOVEL, 1, ChatColor.AQUA + "Clipboard"));

		return gui;
	}

	public static Inventory getWandMenu() {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Wand Menu",
				PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);

		gui.setItem(10, ItemUtils.getSkullItem(1, ItemUtils.flashlight, ChatColor.AQUA + "Position Selection"));
	...
	public static Inventory getModesMenu() {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Player Mode",
				PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);

		gui.setItem(10, ItemUtils.getItem(Material.DIAMOND_AXE, 1, ChatColor.AQUA + "General Mode"));
		gui.setItem(11, ItemUtils.getItem(Material.SHEARS, 1, ChatColor.AQUA + "Sculpting Mode"));
		gui.setItem(12, ItemUtils.getItem(Material.MAGMA_CREAM, 1, ChatColor.AQUA + "Texturing Mode"));

		return gui;
	}

	public static Inventory getPositionMenu() {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Selection Mode",
				PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);

		gui.setItem(10, ItemUtils.getSkullItem(1, ItemUtils.flashlight, ChatColor.AQUA + "Single-Position Selection"));
		gui.setItem(11, ItemUtils.getSkullItem(1, ItemUtils.flashlight, ChatColor.AQUA + "Double-Position Selection"));
		gui.setItem(12, ItemUtils.getSkullItem(1, ItemUtils.flashlight, ChatColor.AQUA + "Multi-Position Selection"));
	...
	public static Inventory getGenerateMenu() {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Generate Menu",
				PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);

		gui.setItem(10, ItemUtils.getSkullItem(1, ItemUtils.flashlight, ChatColor.AQUA + "Cubed Shapes"));
		gui.setItem(11, ItemUtils.getSkullItem(1, ItemUtils.drink, ChatColor.AQUA + "Round Shapes"));
	...
	public static Inventory getOperationsMenu() {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Operations Menu",
				PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);

		gui.setItem(10, ItemUtils.getSkullItem(1, ItemUtils.flashlight, ChatColor.AQUA + "Copy Selection"));
		gui.setItem(11, ItemUtils.getSkullItem(1, ItemUtils.flashlight, ChatColor.AQUA + "Paste Selection"));
		gui.setItem(12, ItemUtils.getSkullItem(1, ItemUtils.flashlight, ChatColor.AQUA + "Rotate Selection"));
		gui.setItem(13, ItemUtils.getSkullItem(1, ItemUtils.flashlight, ChatColor.AQUA + "Flip Selection"));
	...
	public static Inventory getHistoryMenu() {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "History Menu",
				PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
	...
	public static Inventory getCuboidShapesMenu() {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Cuboid Shapes",
				PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);

		gui.setItem(10, ItemUtils.getSkullItem(1, ItemUtils.flashlight, ChatColor.AQUA + "Cube"));
		gui.setItem(11, ItemUtils.getSkullItem(1, ItemUtils.flashlight, ChatColor.AQUA + "Cuboid"));
		gui.setItem(12, ItemUtils.getSkullItem(1, ItemUtils.flashlight, ChatColor.AQUA + "Pyramid"));
		gui.setItem(13, ItemUtils.getSkullItem(1, ItemUtils.flashlight, ChatColor.AQUA + "Prism"));
		return gui;
	}

	public static Inventory getSphericalShapesMenu() {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Spherical Shapes",
				PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);

		gui.setItem(10, ItemUtils.getSkullItem(1, ItemUtils.drink, ChatColor.AQUA + "Sphere"));
		gui.setItem(11, ItemUtils.getSkullItem(1, ItemUtils.drink, ChatColor.AQUA + "Ellipsoid"));
		gui.setItem(12, ItemUtils.getSkullItem(1, ItemUtils.drink, ChatColor.AQUA + "Cylinder"));

		return gui;
	}

	public static Inventory getTextureMasksMenu() {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Mask Menu",
				PencilInterface.SupportedInterfaceSize.LARGE, true, true);

		gui.setItem(10, ItemUtils.getItem(Material.FILLED_MAP, 1, ChatColor.AQUA + "Sphere Mask"));
		gui.setItem(11, ItemUtils.getItem(Material.FILLED_MAP, 1, ChatColor.AQUA + "Spray Mask"));
		gui.setItem(12, ItemUtils.getItem(Material.FILLED_MAP, 1, ChatColor.AQUA + "Splatter Mask"));
		gui.setItem(13, ItemUtils.getItem(Material.FILLED_MAP, 1, ChatColor.AQUA + "Bucket Mask"));
		gui.setItem(14, ItemUtils.getItem(Material.FILLED_MAP, 1, ChatColor.AQUA + "Layered Mask"));
		gui.setItem(15, ItemUtils.getItem(Material.FILLED_MAP, 1, ChatColor.AQUA + "Overlay Mask"));
		gui.setItem(16, ItemUtils.getItem(Material.FILLED_MAP, 1, ChatColor.AQUA + "Fracture Mask"));
		gui.setItem(19, ItemUtils.getItem(Material.FILLED_MAP, 1, ChatColor.AQUA + "Gradient Mask"));
		gui.setItem(20, ItemUtils.getItem(Material.FILLED_MAP, 1, ChatColor.AQUA + "Stroke Mask"));
		gui.setItem(25, ItemUtils.getItem(Material.PAPER, 1, ChatColor.AQUA + "None"));

		return gui;
	}

	public static Inventory getTexturesMenu() {
		ArrayList<Texture> textures = Pencil.getTextureManager().getTextures();
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Textures List",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);

		if (textures.size() == 0) {
			gui.setItem(0, ItemUtils.getNoTexturesItem());
		...
		for (int i = 0; i <= (textures.size() - 1); i++) {
			...
			gui.setItem(i, ItemUtils.getTextureItem(texture));
		}
	...
	public static Inventory getCubeDimensionMenu(int scale) {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Cube Scale",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);

		gui.setItem(13, ItemUtils.getSkullItem(1, ItemUtils.upArrow, ChatColor.AQUA + "+ 1"));
		gui.setItem(22, ItemUtils.getItem(Material.PAPER, 1, ChatColor.AQUA + "Scale = " + scale));
		gui.setItem(31, ItemUtils.getSkullItem(1, ItemUtils.downArrow, ChatColor.AQUA + "- 1"));

		gui.setItem(26, ItemUtils.getSkullItem(1, ItemUtils.rightArrow, ChatColor.AQUA + "Next"));

		return gui;
	}

	public static Inventory getPyramidDimensionMenu(int scale) {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Pyramid Scale",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);
	...
	public static Inventory getCuboidDimensionMenu(int scaleX, int scaleY, int scaleZ) {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Cuboid Scale",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);

		gui.setItem(10, ItemUtils.getSkullItem(1, ItemUtils.upArrow, ChatColor.AQUA + "+ 1"));
		gui.setItem(19, ItemUtils.getItem(Material.PAPER, 1, ChatColor.AQUA + "Scale X = " + scaleX));
		gui.setItem(28, ItemUtils.getSkullItem(1, ItemUtils.downArrow, ChatColor.AQUA + "- 1"));

		gui.setItem(13, ItemUtils.getSkullItem(1, ItemUtils.upArrow, ChatColor.AQUA + "+ 1"));
		gui.setItem(22, ItemUtils.getItem(Material.PAPER, 1, ChatColor.AQUA + "Scale Y = " + scaleY));
		gui.setItem(31, ItemUtils.getSkullItem(1, ItemUtils.downArrow, ChatColor.AQUA + "- 1"));

		gui.setItem(16, ItemUtils.getSkullItem(1, ItemUtils.upArrow, ChatColor.AQUA + "+ 1"));
		gui.setItem(25, ItemUtils.getItem(Material.PAPER, 1, ChatColor.AQUA + "Scale Z = " + scaleZ));
		gui.setItem(34, ItemUtils.getSkullItem(1, ItemUtils.downArrow, ChatColor.AQUA + "- 1"));
	...
	public static Inventory getSphereDimensionMenu(int scale) {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Sphere Scale",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);
	...
	public static Inventory getEllipsoidDimensionMenu(int scaleX, int scaleY, int scaleZ) {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Ellipsoid Scale",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);
	...
	public static Inventory getCylinderDimensionMenu(int scaleX, int scaleY, int scaleZ) {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Cylinder Scale",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);
	...
	public static Inventory getRotationXAxisMenu(int angle) {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Angle X",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);

		gui.setItem(10, ItemUtils.getSkullItem(1, ItemUtils.upArrow, ChatColor.AQUA + "+ 1°"));
		gui.setItem(11, ItemUtils.getSkullItem(1, ItemUtils.upArrow, ChatColor.AQUA + "+ 5°"));
		gui.setItem(12, ItemUtils.getSkullItem(1, ItemUtils.upArrow, ChatColor.AQUA + "+ 30°"));
		gui.setItem(13, ItemUtils.getSkullItem(1, ItemUtils.upArrow, ChatColor.AQUA + "+ 45°"));
		gui.setItem(14, ItemUtils.getSkullItem(1, ItemUtils.upArrow, ChatColor.AQUA + "+ 90°"));
		gui.setItem(15, ItemUtils.getSkullItem(1, ItemUtils.upArrow, ChatColor.AQUA + "+ 135°"));
		gui.setItem(16, ItemUtils.getSkullItem(1, ItemUtils.upArrow, ChatColor.AQUA + "+ 180°"));
		gui.setItem(22, ItemUtils.getItem(Material.PAPER, 1, ChatColor.AQUA + "Angle X = " + angle + "°"));
		gui.setItem(28, ItemUtils.getSkullItem(1, ItemUtils.downArrow, ChatColor.AQUA + "- 1°"));
		gui.setItem(29, ItemUtils.getSkullItem(1, ItemUtils.downArrow, ChatColor.AQUA + "- 5°"));
		gui.setItem(30, ItemUtils.getSkullItem(1, ItemUtils.downArrow, ChatColor.AQUA + "- 30°"));
		gui.setItem(31, ItemUtils.getSkullItem(1, ItemUtils.downArrow, ChatColor.AQUA + "- 45°"));
		gui.setItem(32, ItemUtils.getSkullItem(1, ItemUtils.downArrow, ChatColor.AQUA + "- 90°"));
		gui.setItem(33, ItemUtils.getSkullItem(1, ItemUtils.downArrow, ChatColor.AQUA + "- 135°"));
		gui.setItem(34, ItemUtils.getSkullItem(1, ItemUtils.downArrow, ChatColor.AQUA + "- 180°"));
	...
	public static Inventory getRotationYAxisMenu(int angle) {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Angle Y",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);
	...
	public static Inventory getRotationZAxisMenu(int angle) {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Angle Z",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);
	...
	public static Inventory getHistoryTimeline(PencilPlayer player) {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "History Timeline",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);
		...
		int slot = 0;
		for (PencilAction action : player.getActionManager().getActions()) {
	...
	public static Inventory getActionInventory(PencilPlayer player, ItemStack stack) {
		if (stack.hasItemMeta()) {
			List<String> lore = stack.getItemMeta().getLore();

			for (String str : lore) {
				if (str.contains("ID:")) {
					int ID = TypeUtils.extractNumber(str);

					PencilAction action = player.getActionManager().get(ID);
					Inventory gui = PencilInterface.createPencilInterface(
							Pencil.getPrefix() + ChatColor.GREEN + "Action " + ID,
							PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
	...
	public static Inventory getClipboardView(PencilPlayer player) {
		Inventory gui = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Clipboard",
				PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
	...
	public static MaterialSet getMaterialsInterface() {
		Inventory stone = PencilInterface.createPencilInterface(
				Pencil.getPrefix() + ChatColor.GREEN + "Stone Materials", PencilInterface.SupportedInterfaceSize.HUGE,
				true, true);
		...
		stone.setItem(15,
				ItemUtils.getItem(Material.CHISELED_STONE_BRICKS, 1, ChatColor.AQUA + "Chiseled Stone Bricks"));
		...
		stone.setItem(20,
				ItemUtils.getItem(Material.INFESTED_STONE_BRICKS, 1, ChatColor.AQUA + "Infested Stone Bricks"));
		stone.setItem(21, ItemUtils.getItem(Material.INFESTED_MOSSY_STONE_BRICKS, 1,
				ChatColor.AQUA + "Infested Mossy Stone Bricks"));
		stone.setItem(22, ItemUtils.getItem(Material.INFESTED_CRACKED_STONE_BRICKS, 1,
				ChatColor.AQUA + "Infested Cracked Stone Bricks"));
		stone.setItem(23, ItemUtils.getItem(Material.INFESTED_CHISELED_STONE_BRICKS, 1,
				ChatColor.AQUA + "Infested Chiseled Stone Bricks"));
		...
		stone.setItem(42,
				ItemUtils.getItem(Material.CHISELED_QUARTZ_BLOCK, 1, ChatColor.AQUA + "Chiseled Quartz Block"));
		...
		Inventory natural = PencilInterface.createPencilInterface(
				Pencil.getPrefix() + ChatColor.GREEN + "Natural Materials", PencilInterface.SupportedInterfaceSize.HUGE,
				true, true);
		...
		natural.setItem(6,
				ItemUtils.getItem(Material.SMOOTH_RED_SANDSTONE, 1, ChatColor.AQUA + "Smooth Red Sandstone"));
		natural.setItem(7,
				ItemUtils.getItem(Material.CHISELED_RED_SANDSTONE, 1, ChatColor.AQUA + "Chiseled Red Sandstone"));
		...
		natural.setItem(23,
				ItemUtils.getItem(Material.MOSSY_COBBLESTONE_WALL, 1, ChatColor.AQUA + "Mossy Cobblestone Wall"));
		...
		natural.setItem(34,
				ItemUtils.getItem(Material.BROWN_MUSHROOM_BLOCK, 1, ChatColor.AQUA + "Brown Mushroom Block"));
		...
		Inventory wood = PencilInterface.createPencilInterface(
				Pencil.getPrefix() + ChatColor.GREEN + "Wooden Materials", PencilInterface.SupportedInterfaceSize.HUGE,
				true, true);
		...
		wood.setItem(11,
				ItemUtils.getItem(Material.STRIPPED_DARK_OAK_LOG, 1, ChatColor.AQUA + "Stripped Dark Oak Log"));
		...
		Inventory slab = PencilInterface.createPencilInterface(
				Pencil.getPrefix() + ChatColor.GREEN + "Slab & Stair Materials",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);
		...
		Inventory coloredItemsOne = PencilInterface.createPencilInterface(
				Pencil.getPrefix() + ChatColor.GREEN + "Colored Materials 1",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);

		coloredItemsOne.setItem(45, ItemUtils.getPreviousPageItem());
		coloredItemsOne.setItem(53, ItemUtils.getNextPageItem());
		coloredItemsOne.setItem(0,
				ItemUtils.getItem(Material.BLACK_STAINED_GLASS, 1, ChatColor.AQUA + "Black Stained Glass"));
		coloredItemsOne.setItem(1,
				ItemUtils.getItem(Material.BLACK_STAINED_GLASS_PANE, 1, ChatColor.AQUA + "Black Stained Glass Pane"));
		coloredItemsOne.setItem(2, ItemUtils.getItem(Material.BLACK_WOOL, 1, ChatColor.AQUA + "Black Wool"));
		coloredItemsOne.setItem(3,
				ItemUtils.getItem(Material.BLACK_TERRACOTTA, 1, ChatColor.AQUA + "Black Terracotta"));
		coloredItemsOne.setItem(4,
				ItemUtils.getItem(Material.BLACK_GLAZED_TERRACOTTA, 1, ChatColor.AQUA + "Black Glazed Terracotta"));
		coloredItemsOne.setItem(5,
				ItemUtils.getItem(Material.BLACK_CONCRETE_POWDER, 1, ChatColor.AQUA + "Black Concrete Powder"));
		coloredItemsOne.setItem(6, ItemUtils.getItem(Material.BLACK_CONCRETE, 1, ChatColor.AQUA + "Black Concrete"));

		coloredItemsOne.setItem(9,
				ItemUtils.getItem(Material.WHITE_STAINED_GLASS, 1, ChatColor.AQUA + "White Stained Glass"));
		coloredItemsOne.setItem(10,
				ItemUtils.getItem(Material.WHITE_STAINED_GLASS_PANE, 1, ChatColor.AQUA + "White Stained Glass Pane"));
		coloredItemsOne.setItem(11, ItemUtils.getItem(Material.WHITE_WOOL, 1, ChatColor.AQUA + "White Wool"));
		coloredItemsOne.setItem(12,
				ItemUtils.getItem(Material.WHITE_TERRACOTTA, 1, ChatColor.AQUA + "White Terracotta"));
		coloredItemsOne.setItem(13,
				ItemUtils.getItem(Material.WHITE_GLAZED_TERRACOTTA, 1, ChatColor.AQUA + "White Glazed Terracotta"));
		coloredItemsOne.setItem(14,
				ItemUtils.getItem(Material.WHITE_CONCRETE_POWDER, 1, ChatColor.AQUA + "White Concrete Powder"));
		coloredItemsOne.setItem(15, ItemUtils.getItem(Material.WHITE_CONCRETE, 1, ChatColor.AQUA + "White Concrete"));

		coloredItemsOne.setItem(18,
				ItemUtils.getItem(Material.RED_STAINED_GLASS, 1, ChatColor.AQUA + "Red Stained Glass"));
		coloredItemsOne.setItem(19,
				ItemUtils.getItem(Material.RED_STAINED_GLASS_PANE, 1, ChatColor.AQUA + "Red Stained Glass Pane"));
		...
		coloredItemsOne.setItem(22,
				ItemUtils.getItem(Material.RED_GLAZED_TERRACOTTA, 1, ChatColor.AQUA + "Red Glazed Terracotta"));
		coloredItemsOne.setItem(23,
				ItemUtils.getItem(Material.RED_CONCRETE_POWDER, 1, ChatColor.AQUA + "Red Concrete Powder"));
		coloredItemsOne.setItem(24, ItemUtils.getItem(Material.RED_CONCRETE, 1, ChatColor.AQUA + "Red Concrete"));

		coloredItemsOne.setItem(27,
				ItemUtils.getItem(Material.ORANGE_STAINED_GLASS, 1, ChatColor.AQUA + "Orange Stained Glass"));
		coloredItemsOne.setItem(28,
				ItemUtils.getItem(Material.ORANGE_STAINED_GLASS_PANE, 1, ChatColor.AQUA + "Orange Stained Glass Pane"));
		coloredItemsOne.setItem(29, ItemUtils.getItem(Material.ORANGE_WOOL, 1, ChatColor.AQUA + "Orange Wool"));
		coloredItemsOne.setItem(30,
				ItemUtils.getItem(Material.ORANGE_TERRACOTTA, 1, ChatColor.AQUA + "Orange Terracotta"));
		coloredItemsOne.setItem(31,
				ItemUtils.getItem(Material.ORANGE_GLAZED_TERRACOTTA, 1, ChatColor.AQUA + "Orange Glazed Terracotta"));
		coloredItemsOne.setItem(32,
				ItemUtils.getItem(Material.ORANGE_CONCRETE_POWDER, 1, ChatColor.AQUA + "Orange Concrete Powder"));
		coloredItemsOne.setItem(33, ItemUtils.getItem(Material.ORANGE_CONCRETE, 1, ChatColor.AQUA + "Orange Concrete"));

		coloredItemsOne.setItem(36,
				ItemUtils.getItem(Material.YELLOW_STAINED_GLASS, 1, ChatColor.AQUA + "Yellow Stained Glass"));
		coloredItemsOne.setItem(37,
				ItemUtils.getItem(Material.YELLOW_STAINED_GLASS_PANE, 1, ChatColor.AQUA + "Yellow Stained Glass Pane"));
		coloredItemsOne.setItem(38, ItemUtils.getItem(Material.YELLOW_WOOL, 1, ChatColor.AQUA + "Yellow Wool"));
		coloredItemsOne.setItem(39,
				ItemUtils.getItem(Material.YELLOW_TERRACOTTA, 1, ChatColor.AQUA + "Yellow Terracotta"));
		coloredItemsOne.setItem(40,
				ItemUtils.getItem(Material.YELLOW_GLAZED_TERRACOTTA, 1, ChatColor.AQUA + "Yellow Glazed Terracotta"));
		coloredItemsOne.setItem(41,
				ItemUtils.getItem(Material.YELLOW_CONCRETE_POWDER, 1, ChatColor.AQUA + "Yellow Concrete Powder"));
		coloredItemsOne.setItem(42, ItemUtils.getItem(Material.YELLOW_CONCRETE, 1, ChatColor.AQUA + "Yellow Concrete"));

		Inventory coloredItemsTwo = PencilInterface.createPencilInterface(
				Pencil.getPrefix() + ChatColor.GREEN + "Colored Materials 2",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);

		coloredItemsTwo.setItem(45, ItemUtils.getPreviousPageItem());
		coloredItemsTwo.setItem(53, ItemUtils.getNextPageItem());
		coloredItemsTwo.setItem(0,
				ItemUtils.getItem(Material.LIME_STAINED_GLASS, 1, ChatColor.AQUA + "Lime Stained Glass"));
		coloredItemsTwo.setItem(1,
				ItemUtils.getItem(Material.LIME_STAINED_GLASS_PANE, 1, ChatColor.AQUA + "Lime Stained Glass Pane"));
		...
		coloredItemsTwo.setItem(4,
				ItemUtils.getItem(Material.LIME_GLAZED_TERRACOTTA, 1, ChatColor.AQUA + "Lime Glazed Terracotta"));
		coloredItemsTwo.setItem(5,
				ItemUtils.getItem(Material.LIME_CONCRETE_POWDER, 1, ChatColor.AQUA + "Lime Concrete Powder"));
		coloredItemsTwo.setItem(6, ItemUtils.getItem(Material.LIME_CONCRETE, 1, ChatColor.AQUA + "Lime Concrete"));

		coloredItemsTwo.setItem(9,
				ItemUtils.getItem(Material.GREEN_STAINED_GLASS, 1, ChatColor.AQUA + "Green Stained Glass"));
		coloredItemsTwo.setItem(10,
				ItemUtils.getItem(Material.GREEN_STAINED_GLASS_PANE, 1, ChatColor.AQUA + "Green Stained Glass Pane"));
		coloredItemsTwo.setItem(11, ItemUtils.getItem(Material.GREEN_WOOL, 1, ChatColor.AQUA + "Green Wool"));
		coloredItemsTwo.setItem(12,
				ItemUtils.getItem(Material.GREEN_TERRACOTTA, 1, ChatColor.AQUA + "Green Terracotta"));
		coloredItemsTwo.setItem(13,
				ItemUtils.getItem(Material.GREEN_GLAZED_TERRACOTTA, 1, ChatColor.AQUA + "Green Glazed Terracotta"));
		coloredItemsTwo.setItem(14,
				ItemUtils.getItem(Material.GREEN_CONCRETE_POWDER, 1, ChatColor.AQUA + "Green Concrete Powder"));
		coloredItemsTwo.setItem(15, ItemUtils.getItem(Material.GREEN_CONCRETE, 1, ChatColor.AQUA + "Green Concrete"));

		coloredItemsTwo.setItem(18,
				ItemUtils.getItem(Material.CYAN_STAINED_GLASS, 1, ChatColor.AQUA + "Cyan Stained Glass"));
		coloredItemsTwo.setItem(19,
				ItemUtils.getItem(Material.CYAN_STAINED_GLASS_PANE, 1, ChatColor.AQUA + "Cyan Stained Glass Pane"));
		...
		coloredItemsTwo.setItem(22,
				ItemUtils.getItem(Material.CYAN_GLAZED_TERRACOTTA, 1, ChatColor.AQUA + "Cyan Glazed Terracotta"));
		coloredItemsTwo.setItem(23,
				ItemUtils.getItem(Material.CYAN_CONCRETE_POWDER, 1, ChatColor.AQUA + "Cyan Concrete Powder"));
		coloredItemsTwo.setItem(24, ItemUtils.getItem(Material.CYAN_CONCRETE, 1, ChatColor.AQUA + "Cyan Concrete"));

		coloredItemsTwo.setItem(27,
				ItemUtils.getItem(Material.LIGHT_BLUE_STAINED_GLASS, 1, ChatColor.AQUA + "Light Blue Stained Glass"));
		coloredItemsTwo.setItem(28, ItemUtils.getItem(Material.LIGHT_BLUE_STAINED_GLASS_PANE, 1,
				ChatColor.AQUA + "Light Blue Stained Glass Pane"));
		coloredItemsTwo.setItem(29, ItemUtils.getItem(Material.LIGHT_BLUE_WOOL, 1, ChatColor.AQUA + "Light Blue Wool"));
		coloredItemsTwo.setItem(30,
				ItemUtils.getItem(Material.LIGHT_BLUE_TERRACOTTA, 1, ChatColor.AQUA + "Light Blue Terracotta"));
		coloredItemsTwo.setItem(31, ItemUtils.getItem(Material.LIGHT_BLUE_GLAZED_TERRACOTTA, 1,
				ChatColor.AQUA + "Light Blue Glazed Terracotta"));
		coloredItemsTwo.setItem(32, ItemUtils.getItem(Material.LIGHT_BLUE_CONCRETE_POWDER, 1,
				ChatColor.AQUA + "Light Blue Concrete Powder"));
		coloredItemsTwo.setItem(33,
				ItemUtils.getItem(Material.LIGHT_BLUE_CONCRETE, 1, ChatColor.AQUA + "Light Blue Concrete"));

		coloredItemsTwo.setItem(36,
				ItemUtils.getItem(Material.BLUE_STAINED_GLASS, 1, ChatColor.AQUA + "Blue Stained Glass"));
		coloredItemsTwo.setItem(37,
				ItemUtils.getItem(Material.BLUE_STAINED_GLASS_PANE, 1, ChatColor.AQUA + "Blue Stained Glass Pane"));
		...
		coloredItemsTwo.setItem(40,
				ItemUtils.getItem(Material.BLUE_GLAZED_TERRACOTTA, 1, ChatColor.AQUA + "Blue Glazed Terracotta"));
		coloredItemsTwo.setItem(41,
				ItemUtils.getItem(Material.BLUE_CONCRETE_POWDER, 1, ChatColor.AQUA + "Blue Concrete Powder"));
		coloredItemsTwo.setItem(42, ItemUtils.getItem(Material.BLUE_CONCRETE, 1, ChatColor.AQUA + "Blue Concrete"));

		Inventory coloredItemsThree = PencilInterface.createPencilInterface(
				Pencil.getPrefix() + ChatColor.GREEN + "Colored Materials 3",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);

		coloredItemsThree.setItem(45, ItemUtils.getPreviousPageItem());
		coloredItemsThree.setItem(53, ItemUtils.getNextPageItem());
		coloredItemsThree.setItem(0,
				ItemUtils.getItem(Material.MAGENTA_STAINED_GLASS, 1, ChatColor.AQUA + "Magenta Stained Glass"));
		coloredItemsThree.setItem(1, ItemUtils.getItem(Material.MAGENTA_STAINED_GLASS_PANE, 1,
				ChatColor.AQUA + "Magenta Stained Glass Pane"));
		coloredItemsThree.setItem(2, ItemUtils.getItem(Material.MAGENTA_WOOL, 1, ChatColor.AQUA + "Magenta Wool"));
		coloredItemsThree.setItem(3,
				ItemUtils.getItem(Material.MAGENTA_TERRACOTTA, 1, ChatColor.AQUA + "Magenta Terracotta"));
		coloredItemsThree.setItem(4,
				ItemUtils.getItem(Material.MAGENTA_GLAZED_TERRACOTTA, 1, ChatColor.AQUA + "Magenta Glazed Terracotta"));
		coloredItemsThree.setItem(5,
				ItemUtils.getItem(Material.MAGENTA_CONCRETE_POWDER, 1, ChatColor.AQUA + "Magenta Concrete Powder"));
		coloredItemsThree.setItem(6,
				ItemUtils.getItem(Material.MAGENTA_CONCRETE, 1, ChatColor.AQUA + "Magenta Concrete"));

		coloredItemsThree.setItem(9,
				ItemUtils.getItem(Material.PURPLE_STAINED_GLASS, 1, ChatColor.AQUA + "Purple Stained Glass"));
		coloredItemsThree.setItem(10,
				ItemUtils.getItem(Material.PURPLE_STAINED_GLASS_PANE, 1, ChatColor.AQUA + "Purple Stained Glass Pane"));
		coloredItemsThree.setItem(11, ItemUtils.getItem(Material.PURPLE_WOOL, 1, ChatColor.AQUA + "Purple Wool"));
		coloredItemsThree.setItem(12,
				ItemUtils.getItem(Material.PURPLE_TERRACOTTA, 1, ChatColor.AQUA + "Purple Terracotta"));
		coloredItemsThree.setItem(13,
				ItemUtils.getItem(Material.PURPLE_GLAZED_TERRACOTTA, 1, ChatColor.AQUA + "Purple Glazed Terracotta"));
		coloredItemsThree.setItem(14,
				ItemUtils.getItem(Material.PURPLE_CONCRETE_POWDER, 1, ChatColor.AQUA + "Purple Concrete Powder"));
		coloredItemsThree.setItem(15,
				ItemUtils.getItem(Material.PURPLE_CONCRETE, 1, ChatColor.AQUA + "Purple Concrete"));

		coloredItemsThree.setItem(18,
				ItemUtils.getItem(Material.PINK_STAINED_GLASS, 1, ChatColor.AQUA + "Pink Stained Glass"));
		coloredItemsThree.setItem(19,
				ItemUtils.getItem(Material.PINK_STAINED_GLASS_PANE, 1, ChatColor.AQUA + "Pink Stained Glass Pane"));
		coloredItemsThree.setItem(20, ItemUtils.getItem(Material.PINK_WOOL, 1, ChatColor.AQUA + "Pink Wool"));
		coloredItemsThree.setItem(21,
				ItemUtils.getItem(Material.PINK_TERRACOTTA, 1, ChatColor.AQUA + "Pink Terracotta"));
		coloredItemsThree.setItem(22,
				ItemUtils.getItem(Material.PINK_GLAZED_TERRACOTTA, 1, ChatColor.AQUA + "Pink Glazed Terracotta"));
		coloredItemsThree.setItem(23,
				ItemUtils.getItem(Material.PINK_CONCRETE_POWDER, 1, ChatColor.AQUA + "Pink Concrete Powder"));
		coloredItemsThree.setItem(24, ItemUtils.getItem(Material.PINK_CONCRETE, 1, ChatColor.AQUA + "Pink Concrete"));

		coloredItemsThree.setItem(27,
				ItemUtils.getItem(Material.LIGHT_GRAY_STAINED_GLASS, 1, ChatColor.AQUA + "Light Gray Stained Glass"));
		coloredItemsThree.setItem(28, ItemUtils.getItem(Material.LIGHT_GRAY_STAINED_GLASS_PANE, 1,
				ChatColor.AQUA + "Light Gray Stained Glass Pane"));
		coloredItemsThree.setItem(29,
				ItemUtils.getItem(Material.LIGHT_GRAY_WOOL, 1, ChatColor.AQUA + "Light Gray Wool"));
		coloredItemsThree.setItem(30,
				ItemUtils.getItem(Material.LIGHT_GRAY_TERRACOTTA, 1, ChatColor.AQUA + "Light Gray Terracotta"));
		coloredItemsThree.setItem(31, ItemUtils.getItem(Material.LIGHT_GRAY_GLAZED_TERRACOTTA, 1,
				ChatColor.AQUA + "Light Gray Glazed Terracotta"));
		coloredItemsThree.setItem(32, ItemUtils.getItem(Material.LIGHT_GRAY_CONCRETE_POWDER, 1,
				ChatColor.AQUA + "Light Gray Concrete Powder"));
		coloredItemsThree.setItem(33,
				ItemUtils.getItem(Material.LIGHT_GRAY_CONCRETE, 1, ChatColor.AQUA + "Light Gray Concrete"));

		coloredItemsThree.setItem(36,
				ItemUtils.getItem(Material.GRAY_STAINED_GLASS, 1, ChatColor.AQUA + "Gray Stained Glass"));
		coloredItemsThree.setItem(37,
				ItemUtils.getItem(Material.GRAY_STAINED_GLASS_PANE, 1, ChatColor.AQUA + "Gray Stained Glass Pane"));
		coloredItemsThree.setItem(38, ItemUtils.getItem(Material.GRAY_WOOL, 1, ChatColor.AQUA + "Gray Wool"));
		coloredItemsThree.setItem(39,
				ItemUtils.getItem(Material.GRAY_TERRACOTTA, 1, ChatColor.AQUA + "Gray Terracotta"));
		coloredItemsThree.setItem(40,
				ItemUtils.getItem(Material.GRAY_GLAZED_TERRACOTTA, 1, ChatColor.AQUA + "Gray Glazed Terracotta"));
		coloredItemsThree.setItem(41,
				ItemUtils.getItem(Material.GRAY_CONCRETE_POWDER, 1, ChatColor.AQUA + "Gray Concrete Powder"));
		coloredItemsThree.setItem(42, ItemUtils.getItem(Material.GRAY_CONCRETE, 1, ChatColor.AQUA + "Gray Concrete"));

		Inventory sea = PencilInterface.createPencilInterface(Pencil.getPrefix() + ChatColor.GREEN + "Sea Materials",
				PencilInterface.SupportedInterfaceSize.HUGE, true, true);
		...
		sea.setItem(28,
				ItemUtils.getItem(Material.PRISMARINE_BRICK_STAIRS, 1, ChatColor.AQUA + "Prismarine Brick Stairs"));
		sea.setItem(29,
				ItemUtils.getItem(Material.DARK_PRISMARINE_STAIRS, 1, ChatColor.AQUA + "Dark Prismarine Stairs"));

		sea.setItem(36, ItemUtils.getItem(Material.DRIED_KELP_BLOCK, 1, ChatColor.AQUA + "Dried Kelp Block"));

		Inventory random = PencilInterface.createPencilInterface(
				Pencil.getPrefix() + ChatColor.GREEN + "Random Materials", PencilInterface.SupportedInterfaceSize.HUGE,
				true, true);
		...
		return new MaterialSet(stone, natural, wood, slab, coloredItemsOne, coloredItemsTwo, coloredItemsThree, sea,
				random);
	}
}
