...
public class InterfaceUtils {
    ...
    public static Inventory getCrayonMenu() {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Main Menu", PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
    ...
    public static Inventory getUtilitiesMenu() {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Utilities", PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
    ...
    public static Inventory getWandMenu() {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Wand Menu", PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
    ...
    public static Inventory getModesMenu() {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Player Mode", PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
    ...
    public static Inventory getPositionMenu() {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Selection Mode", PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
    ...
    public static Inventory getGenerateMenu() {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Generate Menu", PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
    ...
    public static Inventory getOperationsMenu() {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Operations Menu", PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
    ...
    public static Inventory getHistoryMenu() {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "History Menu", PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
    ...
    public static Inventory getCuboidShapesMenu() {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Cuboid Shapes", PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
    ...
    public static Inventory getSphericalShapesMenu() {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Spherical Shapes", PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
    ...
    public static Inventory getTextureMasksMenu() {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Mask Menu", PencilInterface.SupportedInterfaceSize.LARGE, true, true);
    ...
    public static Inventory getTexturesMenu() {
        ...
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Textures List", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
    ...
    public static Inventory getPyramidDimensionMenu(int scale) {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Pyramid Scale", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
    ...
    public static Inventory getCuboidDimensionMenu(int scaleX, int scaleY, int scaleZ) {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Cuboid Scale", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
    ...
    public static Inventory getSphereDimensionMenu(int scale) {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Sphere Scale", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
    ...
    public static Inventory getEllipsoidDimensionMenu(int scaleX, int scaleY, int scaleZ) {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Ellipsoid Scale", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
    ...
    public static Inventory getCylinderDimensionMenu(int scaleX, int scaleY, int scaleZ) {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Cylinder Scale", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
    ...
    public static Inventory getRotationXAxisMenu(int angle) {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Angle X", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
    ...
    public static Inventory getRotationYAxisMenu(int angle) {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Angle Y", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
    ...
    public static Inventory getRotationZAxisMenu(int angle) {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Angle Z", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
    ...
    public static Inventory getHistoryTimeline(PencilPlayer player) {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "History Timeline", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
        ...
        if (stack.hasItemMeta()) {
            ...
            for (String str : lore) {
                if (str.contains("ID:")) {
                    ...
                    Inventory gui = PencilInterface.createPencilInterface(
                            Pencil.getPrefix() + ChatColor.GREEN + "Action " + ID, PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
    ...
    public static Inventory getClipboardView(PencilPlayer player) {
        Inventory gui = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Clipboard", PencilInterface.SupportedInterfaceSize.MEDIUM, true, true);
    ...
    public static MaterialSet getMaterialsInterface() {
        Inventory stone = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Stone Materials", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
        ...
        Inventory natural = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Natural Materials", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
        ...
        Inventory wood = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Wooden Materials", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
        ...
        Inventory slab = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Slab & Stair Materials", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
        ...
        Inventory coloredItemsOne = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Colored Materials 1", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
        ...
        Inventory coloredItemsTwo = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Colored Materials 2", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
        ...
        Inventory coloredItemsThree = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Colored Materials 3", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
        ...
        Inventory sea = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Sea Materials", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
        ...
        Inventory random = PencilInterface.createPencilInterface(
                Pencil.getPrefix() + ChatColor.GREEN + "Random Materials", PencilInterface.SupportedInterfaceSize.HUGE, true, true);
